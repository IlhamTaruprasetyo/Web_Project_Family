...
// import announcements from "./information";
...
//   return (
//     <>
//       <section id="pengumuman" className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-background via-background/95 to-background">
//         <div className="container mx-auto px-4">
//           <div ref={headerRef} className={`text-center mb-12 ${headerInView ? "animate-fade-in-up" : "opacity-0"}`}>
...
//               <div
//                 key={a.id}
//                 className={`p-6 rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-all duration-300 shadow-sm hover:shadow-md ${gridInView ? "animate-slide-in-up" : "opacity-0"}`}
